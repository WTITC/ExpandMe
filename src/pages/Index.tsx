  ...
  <div className="container mx-auto px-4">
    ...
    <div className="flex justify-center mt-10">
      <Button variant="outline" size="lg" asChild className="border-primary text-primary hover:bg-primary hover:text-white">
        <Link to="/spotlight">View Spotlight Features</Link>
      </Button>
    </div>
  </div>
</section>
...
<section className="py-20">
  <div className="container mx-auto px-4">
    ...
    {/* --- ADDED BUTTON TO MOVE TO ECHOES --- */}
    <div className="flex justify-center mt-8">
      <Button variant="outline" size="lg" asChild className="border-primary text-primary hover:bg-primary hover:text-white transition-colors">
        <Link to="/echoes">View All Echoes</Link>
      </Button>
    </div>
  </div>
</section>
